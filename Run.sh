...
#-------- ports Variables ---------#
port="443" port1="8080" port2="7070" port3="70" port4="80" port5="444" port6="8070"
...
OUTPUT=$(udocker --allow-root run -e STUNNEL_SERVICE=ssh3 -e STUNNEL_CONNECT=127.0.0.1:22 -e STUNNEL_ACCEPT=$port3 ub18x >> $LOG_FILE 2>&1 &)
OUTPUT=$(udocker --allow-root run -e STUNNEL_SERVICE=ssh4 -e STUNNEL_CONNECT=127.0.0.1:22 -e STUNNEL_ACCEPT=$port4 ub18x >> $LOG_FILE 2>&1 &)
OUTPUT=$(udocker --allow-root run -e STUNNEL_SERVICE=ssh5 -e STUNNEL_CONNECT=127.0.0.1:22 -e STUNNEL_ACCEPT=$port5 ub18x >> $LOG_FILE 2>&1 &)
OUTPUT=$(udocker --allow-root run -e STUNNEL_SERVICE=ssh6 -e STUNNEL_CONNECT=127.0.0.1:22 -e STUNNEL_ACCEPT=$port6 ub18x >> $LOG_FILE 2>&1 &)
...
echo -e "\033[1;33m• ports :- $port,$port1,$port2,$port3,$port4,$port5,$port6 \033[0m"
...
echo -e "\033[1;32m# Script V ==> 3.0 √ \033[0m"
echo "-----------------------------------------------------------------------------------"
