...
#-------- ports Variables ---------#
port="443" port1="8080" port2="7070"
...
echo -e "\033[1;33m#Command Run ====> udocker --allow-root run -e STUNNEL_SERVICE=ssh -e STUNNEL_CONNECT=127.0.0.1:22 -e STUNNEL_ACCEPT=$port,$port1,$port2 ub18x\033[0m"
...
echo -e "\033[1;33m• ports :- $port,$port1,$port2 \033[0m"
